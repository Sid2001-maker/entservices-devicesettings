"""
/**
 * @file TCID14_HdmiVersion.py
 * @brief L3 AVInput functional testcase.
 *
 * @testcase TCID14_HdmiVersion
...
def run_test():
    ...
    if not version:
        log_error("TCID14_HdmiVersion Failed ❌ (HdmiCapabilityVersion missing/empty)")
        return False
    log_success(f"✅ HDMI capability version = {version}")

    elapsed_time = time.perf_counter() - start_time
    msg = "TCID14_HdmiVersion Passed ✅"
