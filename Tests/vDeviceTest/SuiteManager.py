 ...
 *          and executing test case modules, activating the org.rdk.AVInput plugin via
...
SUITES = {
    "avinput": {
        ...
        "tests": [
            ...
            "TCID03_ConnectionHotPlug",
            "TCID04_SignalChange",
            "TCID05_StartStopInput",
            "TCID06_VideoStreamInfoUpdate",
            "TCID07_EdidVersionRoundTrip",
            "TCID08_ReadWriteEdid",
            "TCID09_Edid2AllmSupport",
            "TCID10_GameFeatureAllmStatus",
            "TCID11_AviContentTypeUpdate",
            "TCID12_VrrSupportAndFrameRate",
            "TCID13_GetSpd",
            "TCID14_HdmiVersion",
            "TCID15_SetVideoRectangle",
            "TCID16_ContentProtected",
            "TCID17_InvalidParameterHandling",
            # Scenario / multi-step user journeys
            "TCID18_PortEnumerationConsistency",
            "TCID19_InputSwitchingLifecycle",
            "TCID20_EdidProvisioningWorkflow",
            "TCID21_GameModeProvisioning",
            "TCID22_VrrProvisioning",
            "TCID23_MultiPortIndependence",
            "TCID24_PresentationWindowWorkflow",
            "TCID25_SourceInspectionWorkflow",
            "TCID26_AudioMixingWorkflow",
            "TCID27_NegativeAndBoundaryHandling",
            "TCID28_SettingsPersistAcrossRestart",
            "TCID29_DisconnectedPortBehaviour",
        ],
    },
}
